...
const UserState = (props) => {
    ...
    const getUser = async () => {
        ...
        try {
            if (!localStorage.getItem('token')) {
                ...
                showAlert("You are not logged in! Please log in before use.");
            } else {
            ...
            if (error.request.status === 404) {
                ...
                console.log("Please log in before use.");
                showAlert("Please log in before use.");
            } else {
                setIsError(true);
            }
        } finally {
    ...
    // if (isLoadingUser || isLoadingAccount || isLoadingTransactions) {
    //     return (
